package cn.edu.cczu.zxks.generator;
...
public class MyBatisPlusGenerator {
    ...
    public void codeGenerator() {
        ...
        gc.setAuthor("jjc");//Mapper,Service类注解中显示创建人信息
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/zxks?serverTimezone=UTC&useUnicode=true&useSSL=false&characterEncoding=utf8");
        ...
        pc.setParent("cn.edu.cczu.zxks");  //父级公用包名，就是自动生成的文件放在项目路径下的那个包中
        ...
        strategy.setTablePrefix("tb_");  //表前缀，添加该表示，则生成的实体，不会有表前缀，比如sys_dept 生成就是Dept
